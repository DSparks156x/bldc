...
#define HW_UART_BAUD          115200 //fucked focer life removed the uart, so permanent needed to be moved... whoopsie. 
...
// Hall/encoder pins
#define HW_HALL_ENC_GPIO1       GPIOB //fucked focer life
